...
<head>
    ...
    <title>Calcular o dobro de um número</title>
</head>
<body>
    ...
    <form method="POST" style="text-align:center;margin:10%;background-color:#ffb5ff;padding:5%;"> 
        ...
        <!-- Título -->
        <h1>Calcular o dobro de um número</h1>    
        ...
        <!-- Botão -->
        <!-- Botão de Cálculo do Dobro de um Número -->
        <button type="submit" class="btn btn-primary">Calcular o dobro
            <?php
                ...
                if(isset($_POST['numero'])){
                    ...
                    $resultado = $funcao->dobroNumero($num1);

                }//Fim da Verificação
            ?>
        </button>
        <!-- Fim do Botão de Cálculo do Dobro de um Número -->
