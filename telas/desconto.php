...
<head>
    ...
    <title>Aplicação de 10% de Desconto no Preço de um Produto</title>
</head>
<body>
    ...
    <form method="POST" style="text-align:center;margin:10%;background-color:#ffb5ff;padding:5%;"> 
        ...
        <!-- Título -->
        <h1>Aplicação de 10% de Desconto no Preço de um Produto</h1>    
        ...
        <!-- Botão -->
        <!-- Botão de Aplicação do Desconto -->
        <button type="submit" class="btn btn-primary">Calcular o desconto
            <?php
                ...
                if(isset($_POST['preco'])){
                    ...
                    $resultado = $funcao->aplicarDesconto($preco);

                }//Fim da Verificação
            ?>
        </button>
        <!-- Fim do Botão de Aplicação do Desconto -->
